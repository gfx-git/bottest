...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/gfx-git/bottest/main/install.sh%20&&%20bash%20install.sh
```
...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/gfx-git/bottest/main/install.sh%20&&%20bash%20install.sh -beta
```
...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/gfx-git/bottest/main/install.sh%20&&%20bash%20install.sh -update
```
